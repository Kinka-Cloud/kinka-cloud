    ...
    <div className="pt-20">
      <section className="bg-slate-900 py-32 text-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <span className="text-orange-400 font-black tracking-[0.3em] uppercase text-xs mb-6 block">Kinka Cloud Engineering</span>
          <h1 className="text-5xl md:text-7xl font-black text-white mb-8 italic tracking-tighter">Nosso Ecossistema</h1>
          <p className="text-slate-400 text-lg md:text-xl max-w-2xl mx-auto font-medium leading-relaxed">Tecnologia madura, desenhada para quem não aceita nada menos que a excelência em kinka.cloud.</p>
        </div>
      </section>
      ...
      <section className="py-32 bg-slate-50 border-y border-slate-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="font-black text-slate-900 uppercase tracking-widest text-sm mb-1">Kinka Core Engineering</p>
